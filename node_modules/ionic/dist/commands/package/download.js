...
let PackageDownloadCommand = class PackageDownloadCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.env.tasks.end();
            this.env.log.ok(`Build ${chalk.bold(String(build.id))} downloaded as ${chalk.bold(cli_utils_1.prettyPath(buildFilename))}.`);
        });
    }
};
PackageDownloadCommand = __decorate([
